...
<div class="form-group col-sm-6">
    {!! Form::label('role_no', 'Role No:') !!}
    {!! Form::text('role_no', null, ['class' => 'form-control','maxlength' => 191,'maxlength' => 191]) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('contact_phone', null, ['class' => 'form-control','maxlength' => 191,'maxlength' => 191]) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('current_address', null, ['class' => 'form-control','maxlength' => 191,'maxlength' => 191]) !!}
</div>
